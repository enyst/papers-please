...
|-----------|--------|------|
| `notes/memory/` | 72 | Agent memory — architectures, consolidation, benchmarks, security, tools |
...
| `notes/agentic-engineering/` | 3 | Engineering *with* coding agents — software factories, immutable-artifact receipts, self-improving SDLC loops (sources from everywhere: tweets, blogs, papers) |
...
| `notes/misc/` | 8 | Everything that doesn't fit a category yet (evaluation, survey simulation, ensembling, context-acquisition/active-inference) |
